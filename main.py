...
from calc import calc_0_0, calc_0_1, calc_0_4
from calc import calc_1_0, calc_1_1, calc_1_4
from calc import calc_2_0, calc_2_1, calc_2_4
from calc import calc_3_0, calc_3_1, calc_3_4
from calc import calc_4_0, calc_4_1, calc_4_4
from calc import calc_10_0, calc_10_1, calc_10_4
...
for equipment in equipments:
    ...
    #     elif sub[-1] == 4:  # ГЖ
    #         tree = tree_set.Tree(sub[-1], equipment[-1]).get_tree_set()
    #         data = calc_0_4.Result(scenario_num, equipment, sub, tree).calculation()
    #         for i in data:
    #             equipment_property.Equipment_DB(path_equip_db).add_result(i)
    #         scenario_num += len(data)

    # if equipment[-1] == 1:  # РВС
    #     if sub[-1] == 0:  # ЛВЖ
    #         tree = tree_set.Tree(sub[-1], equipment[-1]).get_tree_set()
    ...
    #     elif sub[-1] == 4:  # ГЖ
    #         tree = tree_set.Tree(sub[-1], equipment[-1]).get_tree_set()
    #         data = calc_1_4.Result(scenario_num, equipment, sub, tree).calculation()
    #         for i in data:
    #             equipment_property.Equipment_DB(path_equip_db).add_result(i)
    #         scenario_num += len(data)
    ...
    #     elif sub[-1] == 4:  # ГЖ
    #         tree = tree_set.Tree(sub[-1], equipment[-1]).get_tree_set()
    #         data = calc_2_4.Result(scenario_num, equipment, sub, tree).calculation()
    #         for i in data:
    #             equipment_property.Equipment_DB(path_equip_db).add_result(i)
    #         scenario_num += len(data)
    #
    ...
    #     elif sub[-1] == 4:  # ГЖ
    #         tree = tree_set.Tree(sub[-1], equipment[-1]).get_tree_set()
    #         data = calc_3_4.Result(scenario_num, equipment, sub, tree).calculation()
    #         for i in data:
    #             equipment_property.Equipment_DB(path_equip_db).add_result(i)
    #         scenario_num += len(data)
    ...
    #     elif sub[-1] == 4:  # ГЖ
    #         tree = tree_set.Tree(sub[-1], equipment[-1]).get_tree_set()
    #         data = calc_4_4.Result(scenario_num, equipment, sub, tree).calculation()
    #         for i in data:
    #             equipment_property.Equipment_DB(path_equip_db).add_result(i)
    #         scenario_num += len(data)
...
for pipeline in pipelines:
    ...
    if pipeline[-1] == 10:  # трубопровод
        if sub[-1] == 0:  # ЛВЖ
            ...
            tree = tree_set.Tree(sub[-1], pipeline[-1]).get_tree_set()
            data = calc_10_4.Result(scenario_num, pipeline, sub, tree).calculation()
            for i in data:
                equipment_property.Equipment_DB(path_equip_db).add_result(i)
            scenario_num += len(data)
