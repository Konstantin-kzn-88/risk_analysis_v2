...
class Result:
    ...
    def calculation(self):
        ...
        scnario_description = 'Разрыв трубопровода на сечение→ отсутствие мгновенного воспламенения→отсуствие отсроченного воспламенения → ликвидация аварии'
        general = [self.pipeline[0], self.pipeline[1], self.pipeline[10], scenario, scnario_value,
                   scnario_description,
                   mass_all, mass_pf]
        ...
        mass_pf = mass_all * PART_NOFULL_DAMAGE
        scnario_description = 'Частичная разгерметизация трубопровода→ отсутствие мгновенного воспламенения→ отсроченное воспламенение → пожар пролива'
        general = [self.pipeline[0], self.pipeline[1], self.pipeline[10], scenario, scnario_value,
                   scnario_description,
        ...
        mass_pf = 0
        scnario_description = 'Частичная разгерметизация трубопровода→ отсутствие мгновенного воспламенения→отсуствие отсроченного воспламенения → ликвидация аварии'
        general = [self.pipeline[0], self.pipeline[1], self.pipeline[10], scenario, scnario_value,
