    ...
    def __init__(self, sub_type: int, eq_type: int):
        ...
        self.data = {
            ...
            2: { # СУГ
                ...
                2: (0.015, 0.01425, 0.27075, 0.035, 0.03325, 0.63175, 1E-5, 5E-5),  # насос
                3: (0.05, 0.19, 0.76, 0.04, 0.16, 0.04, 0.152, 0.608, 1E-5, 1E-4),  # технол.аппараты
                4: (0.05, 0.19, 0.76, 0.04, 0.16, 0.04, 0.152, 0.608, 5E-7, 5E-7),  # цистерна
                10: (0.2, 0.04, 0.76, 0.2, 0.04, 0.76, 1E-6, 5E-6, 3E-7, 2E-6, 1E-7, 5E-7)  # труба СУГ
            },
            4: {  # ГЖ
                0: (0.1, 0.045, 0.855, 0.1, 0.045, 0.855, 1E-6, 1E-5),  # емк. под давлением
                1: (0.1, 0.045, 0.855, 0.1, 0.045, 0.855, 1E-5, 1E-4),  # РВС
                2: (0.015, 0.01425, 0.27075, 0.035, 0.03325, 0.63175, 1E-5, 5E-5),  # насос
                3: (0.1, 0.045, 0.855, 0.1, 0.045, 0.855, 1E-5, 1E-4),  # технол.аппараты
                4: (0.05, 0.0475, 0.9025, 0.05, 0.0475, 0.9025, 5E-7, 5E-7),  # цистерна
                10: (0.2, 0.04, 0.76, 0.2, 0.04, 0.76, 1E-6, 5E-6, 3E-7, 2E-6, 1E-7, 5E-7)  # труба ГЖ
            },
            5: {  # ГГ
                11: (
                    0.2, 0.1152, 0.0768, 0.608, 0.035, 0.0083376, 0.0264024, 0.93026, 1E-6, 5E-6, 3E-7, 2E-6, 1E-7,
                    5E-7)
                # труба ГГ
            },
            6: {  # ГГ+токси
